...
namespace BspLib.Wad.Wad2
{
    public static class Wad
    {
        ...
        public static bool SaveAsWad2(this WadFile wad, string path) => Save(wad, path);
        ...
        public static void Save(WadFile wad, Stream stream)
        {
            ...
            writer.Write((int)wad.Textures.Count(t => t is TextureByteIndexPaletteWithMipmaps || t is TextureByteIndexPalette));
            ...
            for (int i = 0; i < wad.Textures.Count; i++)
            {
                ...
                //TODO Save entry
                throw new NotImplementedException("Saving entry is not implemented yet.");
